...
def p_bloque_ambiente_sr (p):
    '''
        bloque_ambiente : variable comentario_vl_l
                    ...
                    | constante
    '''
    print('Prod. Bloque ambiente_sr')

def p_bloque_ambiente_cr (p):
...
def p_conj_sentencia (p):
    '''conj_sentencia: sentencias conj_sentencia
                    | sentencia
    '''
